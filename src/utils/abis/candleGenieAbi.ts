export default [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum CandleGeniePrediction.Position",
        name: "position",
        type: "uint8",
      },
      { internalType: "uint256", name: "betTimestamp", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "houseBetBullAmount", type: "uint256" },
      { internalType: "uint256", name: "houseBetBearAmount", type: "uint256" },
    ],
    name: "RoundExecute",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_referralsContract", type: "address" },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct CandleGeniePrediction.Round",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256[]", name: "", type: "uint256[]" },
      {
        ...
        internalType: "struct CandleGeniePrediction.Bet[]",
        name: "",
        type: "tuple[]",
      },
      { internalType: "uint256", name: "", type: "uint256" },
