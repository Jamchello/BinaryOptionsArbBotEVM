export default [
  {
    inputs: [
      ...
      { internalType: "string", name: "newPriceSource", type: "string" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "betOnBull", type: "uint256" },
      { internalType: "uint256", name: "betOnBear", type: "uint256" },
    ],
    name: "Execute",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint256", name: "betBull", type: "uint256" },
      { internalType: "uint256", name: "betBear", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "newMinBetAmount", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "roundBufferSeconds", type: "uint256" },
      {
        internalType: "uint256",
